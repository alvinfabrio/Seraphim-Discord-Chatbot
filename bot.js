...
// const { authenticateGoogle, uploadFileToDrive } = require('./googleAuth.js'); // Use .cjs extension
...
//                 },
//                 code_interpreter: {
//                     // Additional settings for the code interpreter can go here if needed
//                     file_ids: [process.env.CODE_INTERPRETER_FILE_ID] 
//                 }
//             },
//             tool_choice: { type: 'code_interpreter' } // or 'file_search' based on your logic
//         }
//     );
...
//     fs.writeFileSync(filePath, response);  // Save the document

//     // Upload the file to Google Drive and get the shareable link
//     const downloadLink = await uploadFileToDrive(fileName, filePath);

//     // Send the download link in Discord
//     message.reply(`Your document is ready! You can download it here: ${downloadLink}`);
